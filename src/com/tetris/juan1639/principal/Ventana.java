...
public class Ventana extends JPanel implements ActionListener, IResetControlesEstados {
	...
	private void inicializa() {
		 ...
		 * 
		 * JButton boton1 = new JButton("Botón 1"); boton1.setVisible(false); JButton
		 * boton2 = new JButton("Botón 2"); JButton boton3 = new JButton("Botón 3");
		 * boton3.setVisible(false); JButton boton4 = new JButton("Botón 4"); JButton
		 * boton5 = new JButton("Botón 5"); boton5.setVisible(false); JButton boton6 =
		 * new JButton("Botón 6"); add(boton1); add(boton2); add(boton3); add(boton4);
		 * add(boton5); add(boton6);
		 */
