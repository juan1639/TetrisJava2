...
{
	public static Fondo[][] instanciarMatrizFondo(Fondo[][] tileFondo, Integer filas, Integer columnas, Integer tileX,
			Integer tileY)
	{
	...
	public static Object[] instanciarPieza(Settings settings, Pieza pieza, NextPieza verNextPieza,
			PlantillaPiezasFactory piezaFactory)
	{
		...
		verNextPieza = new NextPieza(settings.X_NEXT, settings.Y_NEXT, piezaFactory.getPieza().get(nro_rnd),
				Colores.PIEZAS[nro_rnd]);

		// ---------------------------------------------------
		// P I E Z A (Instanciar)
		//
		// ---------------------------------------------------
		pieza = new Pieza(x, y, piezaFactory.getPieza().get(elegida), col, filas, Colores.PIEZAS[elegida], settings);

		return new Object[]
		{ verNextPieza, pieza };
	}

	public static Object[] instanciarMarcadores(Settings settings, Marcadores lineas, Marcadores nivel, Marcadores hi)
	{
